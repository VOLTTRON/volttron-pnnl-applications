...
class TemperatureSensor:
    ...
    def set_class_values(self, analysis_name, results_publish, data_window, no_required_data, temp_diff_threshold, hr_off_steady_state):
    ...
    def temperature_sensor_dx(self):
        ...
        print("info: "+table_log_format(self.analysis_name, self.timestamp[-1], (HR1+DX+":" +str(diagnostic_msg))))
        # self.results_publish.append(...)
