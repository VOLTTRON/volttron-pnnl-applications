...
fig = px.bar(all_cost_hour, barmode='group', labels={"value": "Cost $", "index": "hour"})
fig.write_html('cost_{}.html'.format("hourly"), auto_open=True)

fig = px.bar(all_cost_day, barmode='group', labels={"value": "Cost $", "index": "day"})
fig.write_html('cost_{}.html'.format("day"), auto_open=True)

fig = px.bar(all_cost_month, barmode='group', labels={"value": "Cost $", "index": "month"})
fig.write_html('cost_{}.html'.format("monthly"), auto_open=True)
